...
\begin{enumerate}
	...
	\item Managing and advertising a sign up system for BOP and Pre-BOP DJ slots.
	\begin{enumerate}
	    \item At least 1h of time slots shall be available, each 20 minutes long.
	    \item Time slots will be allocated by random ballot, based on a sign up sheet.
        \item The sign up sheet shall ask prospective DJs for their name, phone number, and intended style of music
        \item The above ballot will be made available when BOP tickets are released, or otherwise a minimum of three days before the event in question.
        \item The successful ballotters and their given time slot will be released on a minimum of 24 hours before the event.
	\end{enumerate}
\end{enumerate}
\section{Affiliated Organisations Representative}
