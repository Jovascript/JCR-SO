...
\npara Where an Officeholder fails to attend three OGMs in a term without giving notice for reasons that they will not be able to attend prior to any of the OGMs, they will automatically resign their post due to inactivity. 
\npara The Office holder must be notified via email by the Vice-President a minimum of 5 days before the agenda is sent out for the next OGM. After being notified, an appeal may be made within 48 hours of receipt of the notification. If no appeal is made, then the Officeholder automatically resigns.
\npara If an appeal is made, a meeting of the Office Holder, the President, the Vice President, and one of the Welfare Representatives will take place to hear explanations for why the Office Holder failed to attend OGMs or give notice of failure to attend. If the three aforementioned trustees judge that the following conditions are fulfilled they may unanimously decide to allow the Office Holder to retain their role:
\begin{enumerate}
	\item the reasons are legitimate, and
	\item the Office Holder will fulfil their role as according to the relevant Standing Orders
\end{enumerate}
\npara If a unanimous decision is not taken to retain the Office Holder, they will automatically resign their position, and the position will be included in the next OGM for election after the hearing.
